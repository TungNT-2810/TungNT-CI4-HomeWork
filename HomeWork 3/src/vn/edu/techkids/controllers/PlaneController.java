...
public class PlaneController extends SingleController {
    ...
    public void shot() {
        Bullet bullet = new Bullet(gameObject.getX() + gameObject.getWidth() / 2 - Bullet.DEFAULT_WIDTH / 2, gameObject.getY(), Bullet.DEFAULT_WIDTH, Bullet.DEFAULT_HEIGHT, true);
    ...
    public static PlaneController getPlaneController1() {
        ...
        if(planeController1 == null) {
            Plane plane = new Plane(100, 500, 70, 60, true);
    ...
    public static PlaneController getPlaneController2() {
        if(planeController2 == null) {
            Plane plane = new Plane(200, 500, 70, 60, true);
